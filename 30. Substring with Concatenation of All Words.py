...
class Tests(unittest.TestCase):
    def tests(self):
        sol = Solution()
        self.assertTrue([0,9] or  [9, 0], sol.findSubstring(s = "barfoothefoobarman", words = ["foo","bar"]))
        self.assertEqual([], sol.findSubstring(s = "wordgoodgoodgoodbestword", words = ["word","good","best","word"]))
        self.assertEqual([6, 9, 12], sol.findSubstring(s = "barfoofoobarthefoobarman", words = ["bar","foo","the"]))
